...
```ruby
gem "minimal-mistakes-jekyll", :git => "https://github.com/garrettmac/minimal-mistakes.git", :branch => "feature/theme-gem"`
```
...
- [`_data/ui-text.yml`](https://github.com/garrettmac/minimal-mistakes/blob/master/_data/ui-text.yml) - UI text [documentation]({{ base_path }}/docs/ui-text/)
- [`_data/navigation.yml`](https://github.com/garrettmac/minimal-mistakes/blob/master/_data/navigation.yml) - navigation [documentation]({{ base_path }}/docs/navigation/)

You'll also need to: 

- Replace `<site root>/index.html` with a modified [Minimal Mistakes `index.html`](https://github.com/garrettmac/minimal-mistakes/blob/master/index.html).
...
[File an issue](https://github.com/garrettmac/minimal-mistakes/issues/new){: .btn .btn--info .btn--large}
